...
// From description, main app icon
...
// Source type icons
export const TxtFileIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...
export const MindMapIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10m-2.657.343A8 8 0 0118.657 17.657S17 15 15 14m-2.657.343A8 8 0 017.343 6.343S9 7 10 9m-.343-2.657A8 8 0 0117.657 18.657S15 17 14 15" />
    </svg>
);
